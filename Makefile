...
mypy: ## Run static type checker
	...
	@mypy --ignore-missing-imports --disallow-incomplete-defs --disallow-untyped-defs securedrop_client/db.py securedrop_client/crypto.py securedrop_client/config.py securedrop_client/gui/__init__.py securedrop_client/resources/__init__.py securedrop_client/storage.py
