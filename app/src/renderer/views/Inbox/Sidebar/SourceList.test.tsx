...
vi.mock("./Sources/Source", () => ({
  default: ({
    ...
    >
      ...
      >
        {source.data.isStarred ? "star" : "no-star"}
      </button>
      <span data-testid={`source-designation-${source.uuid}`}>
        {source.data.journalistDesignation}
      </span>
    </div>
  ),
}));
...
describe("Sources Component", () => {
  ...
  const mockSources: SourceType[] = [
    {
      ...
      data: {
        ...
        isStarred: false,
        journalistDesignation: "alice wonderland",
    ...
    },
    {
      ...
      data: {
        ...
        isStarred: true,
        journalistDesignation: "bob builder",
    ...
    },
    {
      ...
      data: {
        ...
        isStarred: false,
        journalistDesignation: "charlie chaplin",
    ...
    },
    {
      ...
      data: {
        ...
        isStarred: true,
        journalistDesignation: "diana ross",
  ...
  describe("Sort functionality", () => {
    it("sorts sources in descending order by default (newest first)", async () => {
      ...
      // Should be ordered by lastUpdated descending: source-4, source-2, source-1, source-3
    ...
    it("sorts sources in ascending order when sort button is clicked (oldest first)", async () => {
      ...
      // Should be ordered by lastUpdated ascending: source-3, source-1, source-2, source-4
      expect(sourceOrder).toEqual([
        "source-source-3", // 2024-01-14 (oldest)
        "source-source-1", // 2024-01-15
        "source-source-2", // 2024-01-16
