...
// The only origin the window is ever allowed to be on.
const rendererOrigin = useRendererDevServer
...
if (!gotTheLock) {
  ...
  function createWindow(): BrowserWindow {
    ...
    // The renderer never navigates away from its own origin, and never opens
    // new windows.
