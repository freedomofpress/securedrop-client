...
These dialogs are styled for the SecureDrop Client. If you feel like a dialog
requires special styling, adding it here is likely a good call.

All dialogs in this file must inherit from QDialog,
so that they implement the accessibility features provided by Qt.

Please attempt to keep overrides to a minimum in order to
