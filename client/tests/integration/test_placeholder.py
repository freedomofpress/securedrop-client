...
def test_styles_for_placeholder(main_window):
    ...
    assert sign_in.font().family() == "Source Sans Pro"
    ...
    assert to_compose_reply.font().family() == "Source Sans Pro"
    ...
    assert compose_a_reply_to.font().family() == "Source Sans Pro"
    ...
    assert source_name.font().family() == "Source Sans Pro"
...
def test_styles_for_placeholder_no_key(main_window_no_key):
    ...
    assert awaiting_key.font().family() == "Source Sans Pro"
    ...
    assert from_server.font().family() == "Source Sans Pro"
