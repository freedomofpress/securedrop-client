...
from securedrop_client.sdk import API, JSONResponse, ProgressProxy, StreamedResponse
...
class VCRAPI(API):
    ...
    def use_cassette(func):
        ...
        def wrapper(self, *args, **kwargs):
            ...
            with context as cassette, patch.object(VCRAPI, "_cassette", cassette, create=True):
