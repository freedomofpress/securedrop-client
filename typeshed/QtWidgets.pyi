...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    customContextMenuRequested: QtCore.pyqtSignal
...
class QAbstractItemView(QAbstractScrollArea):
    ...
    iconSizeChanged: QtCore.pyqtSignal
    viewportEntered: QtCore.pyqtSignal
...
class QListWidget(QListView):
    ...
    def closePersistentEditor(self, item: QListWidgetItem) -> None: ...  # type: ignore
...
class QMdiArea(QAbstractScrollArea):
    ...
    def setActiveSubWindow(self, window: 'QMdiSubWindow') -> None: ...  # type: ignore
