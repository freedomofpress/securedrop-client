...
from tests.helper import assertEmissions, emitsSignals
...
class TestExportService(unittest.TestCase):
    def test_export_service_responds_with_luks_encrypted_disk_found_by_default(self):
        ...
        emitsSignals(client.query_export_service.emit)  # Act.
        assertEmissions(self, response_emitted_emissions, 1)

        assertEmissions(self, luks_encrypted_disk_found_emissions, 1)
        assertEmissions(self, luks_encrypted_disk_not_found_emissions, 0)
