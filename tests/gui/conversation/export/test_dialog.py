...
class TestExportFileDialog(unittest.TestCase):
    def setUp(self):
        ...
        self.dialog = ExportFileDialog(
            _disk, file_uuid="file_uuid_fd3r4", file_name="file_name_lk4oi"
        )
        self._disk = _disk
    ...
    def test_dialog_text_includes_header_and_body(self):
        ...
        # If the service repsonds quick enough, the successful disk check
        # causes the dialog header to be updated.
        self._export_service.check_disk = MagicMock()
        self.dialog = ExportFileDialog(
            self._disk, file_uuid="file_uuid_fd3r4", file_name="file_name_lk4oi"
        )
